...
public class ColoredTitleGroupAttributeDrawer : OdinGroupDrawer<ColoredTitleGroupAttribute>
{
    ...
    private void DrawTitle()
    {
        ...
        {
            if(Attribute.CustomTitleColorDefined)
                GUIHelper.PushColor(Attribute.CustomTitleColor);
            GUI.Label(titleRect, title, titleStyle);
            if(Attribute.CustomTitleColorDefined)
                GUIHelper.PopColor();
        ...
        if (subtitle != null && !subtitle.IsNullOrWhitespace())
        {
            ...
            {
                if(Attribute.CustomSubTitleColorDefined)
                    GUIHelper.PushColor(Attribute.CustomSubTitleColor);
                GUI.Label(titleRect, subtitle, subtitleStyle);
                if(Attribute.CustomSubTitleColorDefined)
                    GUIHelper.PopColor();
            }
